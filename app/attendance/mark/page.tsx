...
export default function AttendancePageWrapper() {
  return <Suspense fallback={<div className="empty">Loading...</div>}><AttendancePage /></Suspense>;
}
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <div>
          <a href="/attendance" style={{ fontSize: 12, color: "var(--primary)", textDecoration: "none" }}>← Back to Records</a>
          <h1 style={{ fontSize: 22, fontWeight: 700, margin: "4px 0 0" }}>Mark Attendance</h1>
